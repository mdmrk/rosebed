...
fn resourceFor(comptime field: []const u8) Resource {
    return switch (@as(Field, @field(Field, field))) {
        ...
        .achievement => clamped(assets.achievement.bg_png),
        ...
        .squid => clamped(assets.mob.squid_png),
        .ghast => clamped(assets.mob.ghast_png),
        .ghast_fire => clamped(assets.mob.ghast_fire_png),
