...
pub const spec: Animal.Spec = .{
    ...
    .living_sound = assets.sounds.mob.skeleton,
    .hurt_sound = assets.sounds.mob.skeletonhurt,
    .death_sound = assets.sounds.mob.skeletonhurt,
};
...
fn mobCanSpawnHere(animal: *const Animal, world_map: *const world.World, _: i64, rand: *world.JavaRandom) bool {
    const self: *const Skeleton = @fieldParentPtr("animal", animal);
